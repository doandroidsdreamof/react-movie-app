  ...
  return (
    <main className="flex flex-col h-screen  overflow  bg-bg-color">
      <div className="flex flex-1 overflow-x-hidden   overflow-y-auto ">
        ...
        <div className={props.explorePage ? 'hidden' : "aside w-72 order-3 hidden lg:flex border-l border-l-gray-600"}>{props.aside}</div>
        <div className="detail-second-section invisible-overflow flex  flex-1 flex-col  order-2   overflow-y-auto">
          <div className={props.homePage ? `w-onehundred mr-auto  left-0 relative px-0 md:px-16 `: `w-onehundred mr-auto left-0 relative px-0  `} >
