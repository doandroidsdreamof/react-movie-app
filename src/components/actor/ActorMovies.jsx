        ...
        <>
            {actorMovies.map((items, i) => (
                <Link className=' w-fit ' to={`/movie/${items?.id}`}>
                    <div key={i} className=" w-64 bg-gray-100 dark:bg-card-color border dark:border-none shadow-md  dak:bg-card-second h-60 rounded-md duration-200 ease-in hover:animate-pulse">
                        <LazyLoadImage
