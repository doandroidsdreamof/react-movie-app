...
//place_of_birth
  ...
  return (
    ...
    <div className=' flex md:flex-row flex-col   overflow-hidden  md:overflow-auto h-seventy'>
    ...
    <div className="flex  flex-1 flex-col  gap-y-4 overflow  p-0 md:pt-0 md:p-5">
        <h1 className='text-2xl text-gray-100 font-roboto font-medium text-center md:text-left uppercase'>{actorDetail.name ? actorDetail.name : ''}</h1>
        <p className="text-gray-300 font-roboto text-xl mb-1 text-center md:text-left">Biography</p>
  <p className="text-gray-400 font-roboto text-xs md:text-sm leading-4 md:leading-1  text-justify md:text-left px-3 md:px-0">
  <ReactReadMoreReadLess
                charLimit={1000}
                readMoreText={"Read more ▼"}
                readLessText={"Read less ▲"}
                readMoreStyle={{color: 'hsl(226, 100%, 66%)', cursor:'pointer', fontSize:'12px', fontFamily: "'Roboto', sans-serif"}}
                readLessStyle={{color: 'hsl(226, 100%, 66%)', cursor:'pointer', fontSize:'12px', fontFamily: "'Roboto', sans-serif"}}
            >   
