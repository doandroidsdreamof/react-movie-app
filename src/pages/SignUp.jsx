      ...
      <div className="m-auto space-y-8 md:w-8/12 lg:w-full max-h-fit ">
        <div className="rounded-xl  bg-opacity-75 bg-input-card backdrop-blur-2xl   shadow-xl h">
          ...
          <div className="rounded-lg lg:block " hidden>
              <img src={signImage} className="rounded-l-xl object-cover h-onehundred" height="" width="" alt="sign-image" />
            </div>
      ...
      invalid:ring-2 invalid:ring-red-400"
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <label for="pwd" className="text-gray-700 mb-2">
                  ...
                  <div className=" flex w-full mt-4 flex-row h-11 text-center justify-center">
                    <button type="button" className="text-white  justify-center   text-xs w-full bg-[#3f4d5f] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-md   text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                    ...
                    <button type="button" className="text-white justify-center  text-xs w-full bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-md   text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
